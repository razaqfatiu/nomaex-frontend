      ...
      <div className="main">
        ...
        <form className="text-center border rounded border-light p-5 bg-light" id="productForm" onSubmit={this.handleSubmit} encType="multipart/form-data">
          ...
          <div className="form-group row">
            ...
            <div className="col-sm-10">
              <input type="text" className="form-control" name="productDescription" id="productDescription" placeholder="Product Description" onChange={this.handleChange} />
            </div>
          </div>
          ...
          <div className="form-group row">
            <label htmlFor="product-shipping" className="col-sm-2 col-form-label">Product Shipping Cost:</label>
            <div className="col-sm-10">
          ...
          <div className="form-group row">
            <label htmlFor="product-shipping-state" className="col-sm-2 col-form-label">Product Shipping State:</label>
            <div className="col-sm-10">
          ...
          <div className="form-group row">
            <label htmlFor="product-shipping-country" className="col-sm-2 col-form-label">Product Shipping Country:</label>
            <div className="col-sm-10">
          ...
          <div className="form-group row">
            <label htmlFor="eta" className="col-sm-2 col-form-label">Expected Time of Arrival:</label>
            <div className="col-sm-10">
